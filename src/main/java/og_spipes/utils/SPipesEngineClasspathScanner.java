...
public class SPipesEngineClasspathScanner extends DefaultClasspathScanner {
    private static final Logger LOG = LoggerFactory.getLogger(SPipesEngineClasspathScanner.class);
